...
// curl -X POST -H "Content-Type: application/json" -d '{"bookId":"39197b7fbd39284794e21bd2765de775"}'  -b mySessionStore.txt -c mySessionStore.txt localhost:8080/RemoveBookFromLibrary
